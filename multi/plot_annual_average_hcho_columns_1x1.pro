pro plot_annual_average_hcho_columns_1x1
...
Open_Device, /PS,             $
             /Color,               $
             Bits=8,          Filename='/z3/gengguannan/satellite/pictures/omi_hcho_annual_average_'+Yr4+'_tropCS30.05x05.ps', $
             /portrait,       /Inches,              $
...
ctm_get_data,datainfo1,filename = filename1,tau0=tau0,tracer=20
...
margin = margin,				        $  
/Sample,					        $         
title='Annual average HCHO columns: '+Yr4 ,             $
/Quiet,/Noprint,				        $
position=position1,			         	$       
/grid, skip=1,gcolor=gcolor

   TopTitle = '[E+16molec/cm2]'
