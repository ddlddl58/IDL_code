pro plot_annual_average_no2_columns_1x1
...
Open_Device, /PS,             $
             /Color,               $
             Bits=8,          Filename='/z3/gengguannan/satellite/pictures/omi_no2_annual_average_'+Yr4+'_tropCS30_partial_scene.05x05.ps', $
             /portrait,       /Inches,              $
...
margin = margin,				        $  
/Sample,					        $         
title='Annual average NO2 columns: '+Yr4,  $
/Quiet,/Noprint,				        $
position=position1,			         	$       
