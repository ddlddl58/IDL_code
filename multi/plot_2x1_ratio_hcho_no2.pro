...
Open_Device, /PS,             $
             /Color,          $     
             Bits=8,          Filename='/z3/gengguannan/satellite/pictures/ratio_between_hcho_no2_'+ Yr4 +'.ps', $

             /portrait,       /Inches,              $
             XSize=XSize,     YSize=YSize,          $
             XOffset=XOffset, YOffset=YOffset 

filename1 = '/z3/gengguannan/satellite/no2/average/omi_no2_'+ Yr4 +'_tropCS30_partial_scene.05x05.bpch'
filename2 = '/z3/gengguannan/satellite/hcho/average/omi_hcho_'+ Yr4 +'_tropCS30.05x05.bpch'

ctm_get_data,datainfo_1,filename = filename1,tau0=nymd2tau(NYMD0),tracer=1
data18=*(datainfo_1[0].data)

ctm_get_data,datainfo_2,filename = filename2,tau0=nymd2tau(NYMD0),tracer=20
...
for I = 0,InGrid.IMX-1 do begin
  for J = 0,InGrid.JMX-1 do begin
    if (data18[I,J] eq -999.0 or data28[I,J] eq -999.0)                             $ 
        ...
        else data818[I,J] = data28[I,J]*10E16 / (data18[I,J]*10E15)
  endfor
endfor
...
margin = margin,				        $  
/Sample,					        $         
title='Ratio between HCHO and NO2: '+Yr4,               $
/Quiet,/Noprint,				        $
position=position1,			         	$       
