pro plot_annual_average_so2_columns_1x1_difference
...
year1 = 2010
year2 = 2009
Yr4_1 = string(year1,format='(i4.4)')
Yr4_2 = string(year2,format='(i4.4)')
nymd1 = year1*10000L + 12*100L + 31L
nymd2 = year2*10000L + 12*100L + 31L
tau1 = nymd2tau(nymd1)
tau2 = nymd2tau(nymd2)

Open_Device, /PS,             $
             /Color,               $
             Bits=8,          Filename='/z3/gengguannan/satellite/so2/ps/omi_so2_difference_between_'+Yr4_1+'_'+Yr4_2+'_tropCS30_partial_scene.05x05.ps', $
             /portrait,       /Inches,              $
             XSize=XSize,     YSize=YSize,          $
             XOffset=XOffset, YOffset=YOffset 

filename1 = '/z3/gengguannan/satellite/so2/average/omi_so2_'+ Yr4_1 +'_tropCS30_partial_scene.05x05.bpch'
filename2 = '/z3/gengguannan/satellite/so2/average/omi_so2_'+ Yr4_2 +'_tropCS30_partial_scene.05x05.bpch'

ctm_get_data,datainfo_1,filename = filename1,tau0=tau1,tracer=26
data18=*(datainfo_1[0].data)
print,max(data18,min=min),min,mean(data18)

ctm_get_data,datainfo_2,filename = filename2,tau0=tau2,tracer=26
data28=*(datainfo_2[0].data)
print,max(data28,min=min),min,mean(data18)
...
margin = margin,				        $  
/Sample,					        $         
title='Annual average SO2 columns differences between '+Yr4_1+' and '+Yr4_2+' (4-25 scenes)',  $
/Quiet,/Noprint,				        $
position=position1,			         	$       
