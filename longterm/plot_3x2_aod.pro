...
data = fltarr(InGrid.IMX,InGrid.JMX,6)

Dir1 = '/home/gengguannan/work/pm2.5/pm2.5/gc/'
filename1 = Dir1 + 'model_aod_components_yearly.2004'
filename2 = Dir1 + 'model_aod_components_yearly.2005'
filename3 = Dir1 + 'model_aod_components_yearly.2006'
...
RESTORE,filename = filename3
data[*,*,2] = avg_gc_AOD


Dir2 = '/home/gengguannan/satellite/aod/MISR/'
filename4 = Dir2 + 'MISR_0.66x0.50_yearly.2004'
filename5 = Dir2 + 'MISR_0.66x0.50_yearly.2005'
filename6 = Dir2 + 'MISR_0.66x0.50_yearly.2006'

RESTORE,filename = filename4
data[*,*,3] = avg_gc_aod

RESTORE,filename = filename5
data[*,*,4] = avg_gc_aod

RESTORE,filename = filename6
data[*,*,5] = avg_gc_aod
...
data18 = data[I1:I2,J1:J2,0]
data28 = data[I1:I2,J1:J2,1]
data38 = data[I1:I2,J1:J2,2]
data48 = data[I1:I2,J1:J2,3]
data58 = data[I1:I2,J1:J2,4]
data68 = data[I1:I2,J1:J2,5]
...
Open_Device, /PS,             $
             /Color,          $     
             Bits=8,          Filename='/home/gengguannan/work/longterm/result/aod.ps', $
             /portrait,       /Inches,              $
