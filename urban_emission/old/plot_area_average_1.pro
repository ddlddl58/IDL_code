...
CTM_Get_Data, datainfo0, 'LANDMAP', tracer = 802, tau0 = nymd2tau(19850101), filename = filename0
mask = *(datainfo0[0].data)
...
for I = I1,I2 do begin
  for J = J1,J2 do begin
    if (mask[I,J] eq 1) and (data18[I,J] gt 0) and (data28[I,J] gt 0) then begin
      m[I,J] += data18[I,J]
      s[I,J] += data28[I,J]
      nod[I,J] += 1
    endif
