pro annual_average_hcho_column_025x025
...
infile = '/z3/gengguannan/satellite/hcho/'+ Yr4 +'/'+ Mon2 +'/omi_hcho_'+ Yr4 + Mon2 + Day2 +'_025x025.bpch'

CTM_Get_Data, datainfo1, 'IJ-AVG-$', tracer = 20, tau0 = tau0, filename = infile
...
for I = 0,InGrid.IMX-1 do begin
  for J = 0,InGrid.JMX-1 do begin
    if (nod[I,J] gt 0L)             $
        then  hcho[I,J] /= nod[I,J]  $
        else  hcho[I,J] = -999.0
  endfor
endfor

outfile = '/z3/gengguannan/satellite/hcho/average/omi_hcho_'+ Yr4 +'_tropCS30.025x025.bpch'
