pro monthly_average_no2_column_05x0666
...
nymd1 = year*10000L+(m+1)*100L+1*1L
print,nymd
tau0 = nymd2tau(nymd)
tau1 = nymd2tau(nymd1)
...
outfile = '/z3/gengguannan/satellite/no2/ur_emiss/omi_no2_monthly_average_'+ Yr4 + mon2 +'_05x0666.bpch'
