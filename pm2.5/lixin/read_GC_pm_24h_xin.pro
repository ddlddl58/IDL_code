...
Infile2 = InDir + 'ctm.'+ Yr4 + Mon2 +'.bpch'


; Outputfile Info.
OutDir = '/home/gengguannan/work/pm2.5/pm2.5/gc_xin/daily/'+ Yr4 +'/'
Outfile = OutDir + 'model_pm2.5_24h.'+ Yr4 + Mon2 + Day2 +'.hdf'
...
CTM_Get_Data, DataInfo_TEPU, 'DAO-FLDS', Tracer = 5, File = Infile2
...
CTM_Get_Data, DataInfo_PEDGE, 'PEDGE-$', Tracer = 1, File = Infile2
