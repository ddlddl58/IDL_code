...
pm  = fltarr(InGrid.IMX,InGrid.JMX,7)
...
;filename = Dir + 'model_pm2.5_aod_10_12_yearly.'+ Yr4
filename = Dir + 'model_pm2.5_sampled_yearly.'+ Yr4
;Dir = '/home/gengguannan/work/pm2.5/pm2.5/sate_based/'
;filename = Dir + 'MISR_pm2.5_0.66x0.50_yearly.'+ Yr4
;filename = Dir + 'ratio_0.66x0.50_yearly.'+ Yr4

RESTORE,filename = filename

pm[*,*,Year-2004] = avg_gc_pm
;pm[*,*,Year-2004] = avg_misr_pm_cor
;pm[*,*,Year-2004] = avg_ratio
...
data58 = pm[I1:I2,J1:J2,4]
data68 = pm[I1:I2,J1:J2,5]
data78 = pm[I1:I2,J1:J2,6]
...
Open_Device, /PS,             $
             /Color,          $     
             Bits=8,          Filename='/home/gengguannan/work/pm2.5/result/trend_pm2.5.ps', $
             /portrait,       /Inches,              $
