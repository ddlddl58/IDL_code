...
; Time set
Year = 2012L
for Month = 3,3 do begin

if Year eq 2004 or Year eq 2008 or Year eq 2012 $
...
InDir = '/z1/gengguannan/forMEP/met/'
OutDir= '/home/gengguannan/work/MEP/met/'
...
; Output file
OutFileName =  OutDir +'ctm.vc_daily_'+ Yr4 + Mon2 +'_NO2.met.05x0666.bpch'
OutFileName2 =  OutDir +'ctm.vc_monthly_'+ Yr4 + Mon2 +'_NO2.met.05x0666.bpch'
